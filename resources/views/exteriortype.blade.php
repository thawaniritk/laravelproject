     ...
     <form action=""></form>
		...
		@csrf
         <div style="flex-grow: 4">  <img src="{{ $img_name }}" height="100px" width="400px" class="img-thumbnail image">   
 			<!-- <input type="" name="exterior" name="exterior"> -->
          </div>
			<p style="text-align : left; font-size:30px;  ">Exterior Design</p>
	         <div class="butn btn-group-toggle " data-toggle="buttons" style="flex-grow: 4">
					  <label class="btn btn-primary comm firstbtn">
					    <input type="checkbox"   name = "tag[]" value="HOUSE">HOUSE
					  </label>
					  <label class="btn btn-primary comm ">
					    <input type="checkbox"   name = "tag[]" value="TOWNHOUSE">TOWNHOUSE
					  </label>
					  <label class="btn btn-primary comm ">
					    <input type="checkbox"   name = "tag[]" value="MOBILE">MOBILE
					  </label>
					  <label class="btn btn-primary comm ">
					    <input type="checkbox"   name = "tag[]" value="INDUSTRY">INDUSTRY
					  </label>
					  <label class="btn btn-primary comm fifthbtn ">
					    <input type="checkbox"   name = "tag[]" value="APPARTMENT">APPARTMENT
					  </label>
					  <label class="btn btn-primary comm sixthbtn">
					    <input type="checkbox"   name = "tag[]" value="NONE">NONE
					  </label>
				<!-- </div> -->
				      <input type="hidden" name="image" value="{{ $img_name }}">
 					     <input type="checkbox" name="check" value="exterior" style="opacity:0; position:absolute; left:9999px;" Checked><br>
			</div>
